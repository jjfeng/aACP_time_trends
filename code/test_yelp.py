...
def train_rating_model(YELP_TRAIN, fields, criterion, N_EPOCHS=20, split_ratio=0.9, num_hidden=30, embed_dim=50, actual_embed_dim=50):
    SEED = 0
    BATCH_SIZE = 16
    ...
    # Load model
    model = TextSentiment(vocab_size = len(TEXT.vocab), vocab=TEXT.vocab, embed_dim = actual_embed_dim, num_class=1, num_hidden=num_hidden)
